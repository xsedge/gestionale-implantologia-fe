      ...
      <q-form ref="formRef" @submit.prevent="onSubmit">
        ...
        <q-card-section class="implantologia-modal__body">
          <div class="implantologia-form-grid implantologia-form-grid--loose">
            ...
            <q-input v-model="form.cliente" label="Descrizione cliente" dense outlined class="implantologia-form-grid__full" />
            <q-input v-model="form.medico" label="Medico" dense outlined />
            <q-input v-model="form.note" label="Note" dense outlined type="textarea" autogrow class="implantologia-form-grid__full" />
          </div>
        </q-card-section>
...
function aggiornaPrezzo(riga, { force = false, synchronizeListini = false } = {}) {
  ...
  const prezzoBaseDisponibile = riga.prezzoBase != null ? Number(riga.prezzoBase) : (prodotto ? Number(prodotto.prezzoBase) : null)
