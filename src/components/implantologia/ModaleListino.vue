<template>
  <q-dialog :model-value="modelValue" @update:model-value="val => emit('update:modelValue', val)" persistent>
    <q-card class="implantologia-modal implantologia-modal--small">
      <q-form ref="formRef" @submit.prevent="onSubmit">
        ...
        <q-card-section class="implantologia-modal__body">
          <div class="implantologia-form-grid implantologia-form-grid--compact">
            <q-input v-model="form.nome" label="Nome listino" dense outlined :rules="requiredRule" class="implantologia-form-grid__full" />
            ...
            <q-select v-model="form.prodottoIds" :options="prodottiOptions" option-label="nome" option-value="id"
              emit-value map-options label="Prodotti associati" dense outlined multiple use-chips class="implantologia-form-grid__full" />
            <q-input v-model="form.descrizione" label="Descrizione" type="textarea" dense outlined autogrow class="implantologia-form-grid__full" />
